package nl.rivm.screenit.batch.jobs.generalis.clientgegevensverwijderen.clientverwijderen;
...
@Component
@AllArgsConstructor
public class ClientVerwijderenWriter extends BaseWriter<Client>
{
	...
	protected void write(Client client) throws Exception
	{
		...
		{
			LOG.info("Client '{}' heeft nog dossiers, client is niet verwijderd", client.getId());
