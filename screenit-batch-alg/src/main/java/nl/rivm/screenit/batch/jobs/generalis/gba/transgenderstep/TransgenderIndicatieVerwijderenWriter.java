...
@AllArgsConstructor
@Slf4j
public class TransgenderIndicatieVerwijderenWriter extends AbstractIndicatieVerwijderenVoorDoelgroepWriter
{
	@Override
	protected RedenIntrekkenGbaIndicatie getRedenIntrekkenGbaIndicatie()
	{
		return RedenIntrekkenGbaIndicatie.SELECTIEBLOKKADE;
	}
}
