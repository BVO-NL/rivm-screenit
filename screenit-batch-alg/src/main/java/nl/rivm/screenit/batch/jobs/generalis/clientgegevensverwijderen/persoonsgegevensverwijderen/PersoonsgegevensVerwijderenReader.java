...
@Component
public class PersoonsgegevensVerwijderenReader extends AbstractGegevensVerwijderenReader
{
	@Override
	protected Specification<Client> createSpecification()
	{
		return super.createSpecification().and(PersoonSpecification.heeftGbaAdres().with(Client_.persoon));
	}
}
