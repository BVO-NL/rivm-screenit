...
import {
  AdresgegevensBewerkenModalComponent
} from '@algemeen/clientdossier/clientgegevens-tab/pages/components/adresgegevens-panel/adresgegevens-bewerken-modal/adresgegevens-bewerken-modal.component'
