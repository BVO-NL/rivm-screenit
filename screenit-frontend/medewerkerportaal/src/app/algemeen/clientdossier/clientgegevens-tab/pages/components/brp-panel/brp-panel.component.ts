...
import { BrpInfoBewerkenModalComponent } from '@/algemeen/clientdossier/clientgegevens-tab/pages/components/brp-panel/brp-info-bewerken-modal/brp-info-bewerken-modal.component'
...
@Component({
  ...
  styleUrl: './brp-panel.component.scss',
})
