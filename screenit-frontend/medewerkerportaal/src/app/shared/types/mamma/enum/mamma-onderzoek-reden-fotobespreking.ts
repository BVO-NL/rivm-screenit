 ...
 * =========================LICENSE_END==================================
 */
export enum MammaOnderzoekRedenFotobespreking {
  ARCHITECTUURVERSTORING = 'ARCHITECTUURVERSTORING',
...
export const mammaOnderzoekRedenFotobesprekingLabels: Record<MammaOnderzoekRedenFotobespreking, string> = {
  [MammaOnderzoekRedenFotobespreking.ARCHITECTUURVERSTORING]: 'Architectuurverstoring',
  [MammaOnderzoekRedenFotobespreking.ASYMMETRIE]: 'Asymmetrie',
