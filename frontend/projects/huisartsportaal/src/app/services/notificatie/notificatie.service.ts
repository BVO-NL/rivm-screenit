...
import { DsNotificationConfig, DsNotificationRef, DsNotificationService, DsNotificationType } from '@topicus-rgp-ds/web'
...
export class NotificatieService {
  ...
  private toonNotificatie(type: DsNotificationType, message: string, autoClose?: number) {
  ...
  info(message: string) {
    this.toonNotificatie('info', message)
  }
