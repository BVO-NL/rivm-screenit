...
public class FITUitslagOpruimenWriter extends BaseWriter<IFOBTUitslag>
{
	private final ColonFITUitslagRepository fitUitslagRepository;

	@Override
	public void write(IFOBTUitslag analyseResultaat)
	{
		fitUitslagRepository.delete(analyseResultaat);
	}
