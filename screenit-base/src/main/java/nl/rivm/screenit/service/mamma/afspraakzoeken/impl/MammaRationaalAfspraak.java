...
@Slf4j
class MammaRationaalAfspraak extends MammaRationaal
{
	...
	private MammaRationaalAfspraak(MammaCapaciteitBlokDto capaciteitBlok, Range<LocalTime> afspraakPeriode, BigDecimal benodigdeCapaciteit,
	...
	static MammaRationaalAfspraak vanBestaandeAfspraak(MammaAfspraakDto bestaandeAfspraak, MammaAfspraakOptieZoekContext zoekContext)
	{
		var rationaalAfspraak = new MammaRationaalAfspraak(bestaandeAfspraak.getCapaciteitBlokDto(),
		...
		rationaalAfspraak.setGeldigeAfspraak(true);
		return rationaalAfspraak;
	}

	static MammaRationaalAfspraak voorNieuweOptie(LocalTime vanaf, LocalTime tot, MammaCapaciteitBlokDto capaciteitBlok, MammaAfspraakOptieZoekContext zoekContext)
	{
		return new MammaRationaalAfspraak(capaciteitBlok, Range.closedOpen(vanaf, tot),
	...
	MammaRationaalAfspraak splitsNieuweAfspraakOptie(MammaAfspraakOptieZoekContext zoekContext)
	{
		MammaRationaalAfspraak nieuweOptie;
	...
	private MammaRationaalAfspraak maakNieuweOptie(LocalTime nieuweVanaf, MammaAfspraakOptieZoekContext zoekContext)
	{
	...
	private void controleerDatNieuweOptieVoorEindtijdBlokBegint(MammaRationaalAfspraak nieuweOptie)
	{
		nieuweOptie.geldigeAfspraak &= eindtijdBlok.isAfter(nieuweOptie.vanaf); 
	}

	private void controleerDatNieuweDubbeleTijdOptieNietGelijkValtMetBestaandeAfspraak(MammaRationaalAfspraak nieuweOptie)
	{
	...
	private void controleerDatBestaandeAfspraakGeldigBlijft(MammaRationaalAfspraak nieuweOptie)
	{
	...
	private MammaRationaalAfspraak maakNieuweOptieInPassendTijdvak(LocalTime nieuweOnafgerondeVanaf, MammaAfspraakOptieZoekContext zoekContext)
	{
	...
	private MammaRationaalAfspraak kiesBesteOptie(LocalTime nieuweOnafgerondeVanaf, MammaRationaalAfspraak optieVroegeTijdvak,
		MammaRationaalAfspraak optieLateTijdvak)
	{
	...
	private MammaRationaalAfspraak kiesDichtstbijzijndeOptie(LocalTime onafgerondeVanaf, MammaRationaalAfspraak optieVroegeTijdvak,
		MammaRationaalAfspraak optieLateTijdvak)
	{
	...
	private MammaRationaalAfspraak maakNieuweOptieInKleinstMogelijkeTijdvak(MammaAfspraakOptieZoekContext zoekContext)
	{
