...
public class ColonHoudbaarheidFitReeksSpecification
{
	public static Specification<ColonHoudbaarheidFitReeks> heeftBarcodeInRange(String barcode)
	{
	...
	public static ExtendedSpecification<ColonHoudbaarheidFitReeks> overlaptBarcode(Range<String> barcodeRange)
	{
		return overlapt(barcodeRange, r -> r.get(AbstractHoudbaarheid_.barcodeStart), r -> r.get(AbstractHoudbaarheid_.barcodeEnd));
	}

	public static ExtendedSpecification<ColonHoudbaarheidFitReeks> heeftBarcodeLengte(int lengte)
	{
