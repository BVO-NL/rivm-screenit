...
public class ColonFitAnalyseResultaatSpecification
{
	public static ExtendedSpecification<ColonFitAnalyseResultaat> heeftAnalyseDatumTussen(Range<Date> peilRange)
	{
		return bevat(peilRange, r -> r.get(ColonFitAnalyseResultaat_.analyseDatum));
	}
}
