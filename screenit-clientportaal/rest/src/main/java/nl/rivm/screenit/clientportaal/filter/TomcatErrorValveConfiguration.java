...
@Configuration
public class TomcatErrorValveConfiguration
{
	@Bean
	public WebSocketTomcatWebServerFactoryCustomizer errorValveCustomizer()
	{
		return new WebSocketTomcatWebServerFactoryCustomizer()
		{
			@Override
			public void customize(@NonNull ConfigurableTomcatWebServerFactory factory)
			{
