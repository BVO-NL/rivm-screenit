...
public interface OpenstaandeUitnodigingService
{
	boolean verwerkMeedoen(Client client, OpenstaandeUitnodigingMeedoenRequest request);

	List<OpenstaandeUitnodigingDto> getOpenstaandeUitnodigingen(Client client);
}
