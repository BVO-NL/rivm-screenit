...
const SearchResultDigitaleIntakeAfspraken: FC<SearchResultProps> = (props: SearchResultProps) => {
	return (
		<div className={classNames(props.className, styles.content)}
			...
			<Row>
				...
				<Col sm={6} className={classNames(styles.hoverOverlay, bvoStyle.baseBackgroundColor)}>
...
export default SearchResultDigitaleIntakeAfspraken
