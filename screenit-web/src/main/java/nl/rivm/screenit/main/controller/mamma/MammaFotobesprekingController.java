...
@AllArgsConstructor
@RestController
@RequestMapping("/mamma/fotobespreking")
@Tag(name = "Mamma fotobespreking", description = "Beheer van fotobesprekingen binnen mamma")
public class MammaFotobesprekingController
{
	...
	@GetMapping("/{id}")
	@Operation(summary = "Haal een fotobespreking op", description = "Geeft de details van een fotobespreking terug op basis van het id.")
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Fotobespreking succesvol opgehaald"),
		@ApiResponse(responseCode = "404", description = "Fotobespreking niet gevonden"),
	...
	public ResponseEntity<MammaFotobesprekingDto> getFotobespreking(@Parameter(description = "Id van de fotobespreking") @PathVariable long id)
	{
	...
	@Operation(summary = "Voeg onderzoeken toe aan een fotobespreking", description = "Voegt de geselecteerde clientonderzoeken toe aan een bestaande fotobespreking.")
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Onderzoeken succesvol verwerkt"),
		@ApiResponse(responseCode = "404", description = "Fotobespreking niet gevonden"),
		@ApiResponse(responseCode = "500", description = "Onverwachte fout opgetreden")
	})
	@SecurityConstraint(
		...
		recht = { Recht.MEDEWERKER_FOTOBESPREKING },
		organisatieTypeScopes = { OrganisatieType.BEOORDELINGSEENHEID, OrganisatieType.SCREENINGSORGANISATIE, OrganisatieType.RIVM })
	public ResponseEntity<MammaFotobesprekingOnderzoekResponseDto> voegOnderzoekenToeAanFotobespreking(
		@Parameter(description = "Id van de fotobespreking") @PathVariable long id,
		@Parameter(description = "Te koppelen clientonderzoeken") @RequestBody MammaFotobesprekingOnderzoekRequestDto requestDto)
	{
		var fotobespreking = fotobesprekingService.getFotobespreking(id);
		if (fotobespreking == null)
		{
	...
	@Operation(summary = "Haal filteropties voor fotobesprekingen op", description = "Geeft de beschikbare filteropties voor fotobesprekingonderzoeken terug.")
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Filteropties succesvol opgehaald"),
		@ApiResponse(responseCode = "500", description = "Onverwachte fout opgetreden")
	})
	@SecurityConstraint(
		constraint = ShiroConstraint.HasPermission,
