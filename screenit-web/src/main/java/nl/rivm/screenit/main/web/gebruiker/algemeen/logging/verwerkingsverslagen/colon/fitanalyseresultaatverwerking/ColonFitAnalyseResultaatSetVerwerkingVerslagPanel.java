package nl.rivm.screenit.main.web.gebruiker.algemeen.logging.verwerkingsverslagen.colon.fitanalyseresultaatverwerking;
...
public class ColonFitAnalyseResultaatSetVerwerkingVerslagPanel extends GenericPanel<ColonFitAnalyseResultaatSetVerwerkingBeeindigdLogEvent>
{
	@SpringBean
	private HibernateService hibernateService;

	public ColonFitAnalyseResultaatSetVerwerkingVerslagPanel(String id, IModel<ColonFitAnalyseResultaatSetVerwerkingBeeindigdLogEvent> model, final LogGebeurtenis logGebeurtenis)
	{
		...
		add(new PropertyListView<>("rapportage.verwerkingen", ModelUtil.listRModel(verwerkingen, false))
		{
	...
	private Integer getAantalTotaalBestanden(List<ColonFitAnalyseResultaatSetVerwerkingRapportageEntry> verwerkingen)
	{
