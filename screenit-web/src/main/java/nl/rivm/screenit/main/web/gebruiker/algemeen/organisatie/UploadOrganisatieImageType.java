...
public enum UploadOrganisatieImageType implements UploadImageType<Organisatie>
{

	DK_SO_LOGO_INPAKCENTRUM("logo.naam")
		{
			@Override
			public UploadDocument getUploadDocument(IModel<Organisatie> model)
			{
	...
	UploadOrganisatieImageType(String labelnaam)
	{
	...
	private static ScreeningOrganisatie getScreningOrganisatie(IModel<Organisatie> model)
	{
		return (ScreeningOrganisatie) model.getObject();
	}

	private static BMHKLaboratorium getBMHKLaboratorium(IModel<Organisatie> model)
	{
