...
public class CervixHoudbaarheidZasReeksOverzichtPage extends HoudbaarheidOverzichtPage<CervixHoudbaarheidZasReeks>
{

	@Override
	protected HoudbaarheidEditPage<CervixHoudbaarheidZasReeks> createEditPage(IModel<CervixHoudbaarheidZasReeks> model)
	{
		if (model == null)
		{
			return new CervixHoudbaarheidZasReeksEditPage();
		}
		else
		{
			return new CervixHoudbaarheidZasReeksEditPage(model);
		}
	}
