...
public class BrpParametersPanel extends BasePrimaireParametersPanel
{
	public BrpParametersPanel(String id, IModel<Parameterisatie> model)
	{
		super(id, model);
	}
	...
	protected Component createAndGetOpslaanLink()
	{
		return new AjaxSubmitLink("opslaan")
		{
			...
			protected void onSubmit(AjaxRequestTarget target)
			{
				...
				info("BRP parameters zijn opgeslagen");
			}
		};
	}
}
