...
@SecurityConstraint(
	...
	recht = { Recht.MEDEWERKER_MAMMA_RADIOLOGIEAFDELING_ORG_BEHEER },
	checkScope = true,
...
public class AanvullendeRadiologieGegevensPage extends AanvullendeMammaAfdelingGegevensPage
{
	...
	{
		var mammapoli = (RadiologieAfdeling) getCurrentSelectedOrganisatie();
		...
		setAlleenInzien(getCurrentSelectedOrganisatie(), Recht.MEDEWERKER_MAMMA_RADIOLOGIEAFDELING_ORG_BEHEER);
