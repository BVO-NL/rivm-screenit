...
import nl.rivm.screenit.main.dto.algemeen.BezwaarDto;
...
public interface BezwaarMapper
{
	@Mappings({
		...
		@Mapping(target = "bevolkingsonderzoek", source = "bevolkingsonderzoek"),
	})
	BezwaarDto bezwaarToDto(Bezwaar bezwaar);
}
