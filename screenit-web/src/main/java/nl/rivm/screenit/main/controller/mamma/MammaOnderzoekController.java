...
@AllArgsConstructor
@RestController
@RequestMapping("/mamma/onderzoek")
@Tag(name = "Mamma onderzoeken", description = "Zoeken van mamma-onderzoeken voor fotobespreking")
public class MammaOnderzoekController
{
	...
	@PostMapping("/zoeken")
	@Operation(summary = "Zoek onderzoeken", description = "Zoekt onderzoeken op basis van filtercriteria.")
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Onderzoeken succesvol gevonden"),
	...
	public ResponseEntity<PagineringResponseDto<List<MammaOnderzoekDto>>> zoekFotobesprekingOnderzoeken(
		@Parameter(description = "Zoekfilter en paginering voor onderzoeken") @RequestBody PagineringRequestDto<MammaFotobesprekingOnderzoekFilterDto> body)
	{
