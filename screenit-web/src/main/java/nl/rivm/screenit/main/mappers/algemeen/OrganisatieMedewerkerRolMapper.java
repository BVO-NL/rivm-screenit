...
public interface OrganisatieMedewerkerRolMapper
{
	@Mapping(target = "rol", qualifiedByName = "skipParentRol")
	OrganisatieMedewerkerRolDto organisatieMedewerkerRolToDto(OrganisatieMedewerkerRol organisatieMedewerkerRol);
}
