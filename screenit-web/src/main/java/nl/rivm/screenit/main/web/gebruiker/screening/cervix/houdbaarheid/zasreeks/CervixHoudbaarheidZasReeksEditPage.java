...
public class CervixHoudbaarheidZasReeksEditPage extends HoudbaarheidEditPage<CervixHoudbaarheidZasReeks>
{
	@SpringBean
	...
	public CervixHoudbaarheidZasReeksEditPage()
	{
		super(ModelUtil.cModel(new CervixHoudbaarheidZasReeks()));
	}

	public CervixHoudbaarheidZasReeksEditPage(IModel<CervixHoudbaarheidZasReeks> model)
	{
		super(model);
	}
	...
	{
		return CervixHoudbaarheidZasReeksOverzichtPage.class;
	}
