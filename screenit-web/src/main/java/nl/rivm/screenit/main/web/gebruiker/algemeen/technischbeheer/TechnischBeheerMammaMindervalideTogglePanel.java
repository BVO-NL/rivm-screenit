...
public class TechnischBeheerMammaMindervalideTogglePanel extends BaseTechnischBeheerParametersPanel
{
	public TechnischBeheerMammaMindervalideTogglePanel(String id, IModel<Parameterisatie> model)
	{
	...
	protected Form<Parameterisatie> createAndGetForm()
	{
		...
		form.add(new CheckBox("mammaMindervalideReserveringActief"));
