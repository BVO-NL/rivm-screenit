...
public enum UploadMedewerkerImageType implements UploadImageType<Medewerker>
{

	HANDTEKENING("handtekening.naam")
		{
			@Override
			public UploadDocument getUploadDocument(IModel<Medewerker> model)
			{
	...
	UploadMedewerkerImageType(String labelnaam)
	{
