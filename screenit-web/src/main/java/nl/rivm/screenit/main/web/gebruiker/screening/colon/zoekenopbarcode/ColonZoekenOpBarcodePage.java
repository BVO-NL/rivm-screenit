...
public class ColonZoekenOpBarcodePage extends ColonScreeningBasePage
{
	@SpringBean
	...
	public ColonZoekenOpBarcodePage()
	{
		...
		ColonZoekFitRegistratieMetBarcodePanel scanVoorFitRegistratie = new ColonZoekFitRegistratieMetBarcodePanel("scanVoorFitRegistratie")
		{
			...
			protected void fitRegistratieGevonden(ColonFitRegistratie fitRegistratie, AjaxRequestTarget target)
			{
				...
				{
					clientModel.setObject(fitRegistratie.getScreeningRonde().getDossier().getClient());
	...
	protected List<MedewerkerMenuItem> getContextMenuItems()
	{
		...
		contextMenuItems.add(new MedewerkerMenuItem("label.zoekenopbarcode", ColonZoekenOpBarcodePage.class));
