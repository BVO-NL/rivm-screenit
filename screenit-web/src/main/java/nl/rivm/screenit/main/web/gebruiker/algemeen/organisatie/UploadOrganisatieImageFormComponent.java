...
public class UploadOrganisatieImageFormComponent extends UploadImageFormComponent<Organisatie>
{
	public UploadOrganisatieImageFormComponent(String id, IModel<Organisatie> model, final UploadOrganisatieImageType whatToUpload)
	{
